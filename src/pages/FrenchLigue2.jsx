...
import {FrenchLigue2Directory} from '../directories/Directory.frenchLigue2';
import '../index.css'

const FrenchLigue2 = () => {

  const leagueName = FrenchLigue2Directory
  ...
  const FrenchLigue2Teams = [
    {value: "Amiens", label: "Amiens"}, {value: "Annecy",label: "Annecy"}, {value: "Bastia", label: "Bastia"}, {value: "Bordeaux", label: "Bordeaux"}, {value: "Caen",label: "Caen"}, {value: "Dijon",label: "Dijon"}, {value: "Grenoble",label: "Grenoble"}, {value: "Guingamp",label: "Guingamp"}, {value: "Laval",label: "Laval"}, {value: "Le Havre",label: "Le Havre"},  {value: "Metz",label: "Metz"},{value: "Nimes",label: "Nimes"}, {value: "Niort",label: "Niort"}, {value: "Paris FC",label: "Paris FC"}, {value: "Pau FC",label: "Pau FC"}, {value: "Quevilly Rouen",label: "Quevilly Rouen"}, {value: "Rodez",label: "Rodez"}, {value: "Sochaux",label: "Sochaux"}, {value: "St. Etienne",label: "St. Etienne"}, {value: "Valenciennes",label: "Valenciennes"}
  ]
...
if (isNaN(homeStrengthLtd) || isNaN(awayStrengthLtd)) {
  ltdStrat = false
} if ((homeStrengthLtd > 0.49) && (homeStrengthLtd < 1.7) && ((awayStrengthLtd > 0)) &&(awayStrengthLtd < 2.2)) {
  ltdStrat = true
}
...
if (isNaN(homeStrengthOvers) || isNaN(awayStrengthOvers)) {
  oversStrat = false
} if ((homeStrengthOvers > 1.24) && (homeStrengthOvers < 2.01) && ((awayStrengthOvers > 0.49)) &&(awayStrengthOvers < 1.5)) {
  oversStrat = true
}
...
} if ((homeSecondHalfOvers > 0.49) && (homeSecondHalfOvers < 2) && (awaySecondHalfOvers > 0.4) &&(awaySecondHalfOvers < 2.51)  && (totalAvgHomeGoalsSecondHalfFormation125 > 0.5)&& (totalAvgHomeGoalsSecondHalfFormation125 < 2.4) && (totalAvgAwayGoalsSecondHalfFormation125 > 0.67) && (totalAvgAwayGoalsSecondHalfFormation125 < 1.7)) {
    ...
    <form action="submit" onClick={handleSubmit}>
      <div className='form-container'>
        <div className="form-items" >
          <Select options={FrenchLigue2Teams} onChange={handleHomeTeamChange1} className="team-input" placeholder="Home Team" />
          <Select options={formaton} onChange={handleHomeFormationChange1} className="formation-input" placeholder="Formation"/>
          <Select options={FrenchLigue2Teams} onChange={handleAwayTeamChange1} className="team-input" placeholder="Away Team"/>
