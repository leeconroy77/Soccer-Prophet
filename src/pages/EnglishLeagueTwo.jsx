...
import {EnglishLeagueTwoDirectory} from '../directories/Directory.englishLeagueTwo';
import '../index.css'
...
if (isNaN(averageFormationBothTeams125) || isNaN(averageSeondHalfBothTeams125)) {
  oversStrat1 = false
} else if ((totalFormationSecondHalfGoalsHome125 > 1.59) && (totalFormationSecondHalfGoalsHome125 < 3.01) && ((totalFormationSecondHalfGoalsAway125 > 1)) &&(totalFormationSecondHalfGoalsAway125 < 2.01) && (averageFormationBothTeams125 > 1.99) && (averageFormationBothTeams125 < 5.01)) {
  oversStrat1 = true
}
...
console.log(oversStrat1);
  ...
  return (
    <>
    <h1 className='h1'>English League Two</h1>
    <form action="submit" onClick={handleSubmit}>
      <div className='form-container'>
        <div className="form-items" >
          <Select options={EnglishLeagueTwoTeams} onChange={handleHomeTeamChange1} className="team-input" placeholder="Home Team" />
