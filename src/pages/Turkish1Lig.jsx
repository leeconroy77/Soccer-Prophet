...
const TurkishLig1 = () => {
  ...
  const leagueName = Turkish1LigDirectory
...
if (isNaN(homeStrengthLtd) || isNaN(awayStrengthLtd)) {
  ltdStrat = false
} if ((homeStrengthLtd > 0.49) && (homeStrengthLtd < 3) && ((awayStrengthLtd > 0.49)) &&(awayStrengthLtd < 1.7)) {
  ltdStrat = true
}
...
if (isNaN(homeStrengthOvers) || isNaN(awayStrengthOvers)) {
  oversStrat = false
} if ((homeStrengthOvers > 1) && (homeStrengthOvers < 3) && ((awayStrengthOvers > 0.5)) &&(awayStrengthOvers < 2.25)) {
  oversStrat = true
}
...
} if ((homeSecondHalfOvers > 0.7) && (homeSecondHalfOvers < 2.51) && (awaySecondHalfOvers > 0.3) &&(awaySecondHalfOvers < 1.8)  && (totalAvgHomeGoalsSecondHalfFormation125 > 0.49)&& (totalAvgHomeGoalsSecondHalfFormation125 < 3.01) && (totalAvgAwayGoalsSecondHalfFormation125 > 0.49) && (totalAvgAwayGoalsSecondHalfFormation125 < 3.01)) {
